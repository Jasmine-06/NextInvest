                ...
                <CardContent className="px-8 pb-8">
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                            ...
                            <p className='text-left text-sm'>Already have an account? <Link href="/login" className='text-emeraldGreen hover:underline'>Login</Link></p>
                            <Button
                                type="submit"
                                className="w-full py-6 rounded-xl bg-emeraldGreen hover:bg-emeraldGreen/90 
